...
data_startday = datetime('2000-01-01', 'InputFormat', 'yyyy-MM-dd');   %2014-01-01是生成mat数据的第一天，可修改
...
Dx = 6370.997 * cos(YllCorner *pi / 180) * DDem * pi / 180 * 1000;   %度转米
    ...
    for i = 1 : TSteps
        ...
        for k = 1 : DRMGCNo
            ...
            if GridTObs(ii,jj) < 0
                ...
                GridTn(ii,jj) = GridTObs(ii,jj) + GridTn(ii,jj);
                FIa(ii,jj) = GridTn(ii,jj);
                SFD(ii,jj) = 37 * (abs(FIa(ii,jj)))^0.5;
            else
                if SFD(ii,jj) == 0
                    GridTm(ii,jj) = 0;
                end
                GridTm(ii,jj) = GridTObs(ii,jj) + GridTm(ii,jj);
                TIa(ii,jj) = GridTm(ii,jj);
                SFD(ii,jj) = SFDi(ii,jj) -  37 * (abs(TIa(ii,jj)))^0.5;

                if SFD(ii,jj) < 0
                    SFD(ii,jj) = 0;
                end
            end
            SFDd = SFD(ii,jj) - SFDi(ii,jj);

            if Wi > 70
                SFDd =  0.3 * SFDd;
                SFD(ii,jj) = SFDi(ii,jj) + SFDd;
            end

            if SFD(ii,jj) > 0
                if  SFDd > 0
                    if  SFDg(ii,jj) > 0
                        SFDg(ii,jj) = SFDg(ii,jj) - abs(SFDd);
                    end
                    if SFDg(ii,jj) < 0
                        SFDg(ii,jj)  = 0;
                    end
            ...
            if SFDg(ii,jj) == 0 && SFD(ii,jj) > 10
                ...
                if SFD(ii,jj) < HumousT(ii, jj)
                    GSi = GS * (SFD(ii,jj) / HumousT(ii, jj));
                    GSw = GS * (1 - SFD(ii,jj) / HumousT(ii, jj));
                else
                    GSi = GS;
                    GSw = 0;
                end
                ...
                if SFD(ii,jj) < ZUpper
                    GWUi = GWU * (SFD(ii,jj) / ZUpper);
                    GWLi = 0;
                    GWDi = 0;
                    GWUw = GWU * (1 - SFD(ii,jj) / ZUpper);
                    GWLw = GWL;
                    GWDw = GWD;

                elseif SFD(ii,jj) >= ZUpper && SFD(ii,jj) <=(ZLower + ZUpper)
                    GWUi = GWU ;
                    GWLi = GWL * ((SFD(ii,jj) - ZUpper )/ ZLower);
                    GWDi = 0;
                    GWUw = 0;
                    GWLw = GWL * (1 - (SFD(ii,jj) - ZUpper )/ ZLower);
                    GWDw = GWD;

                elseif SFD(ii,jj) >(ZLower + ZUpper) && SFD(ii,jj) <= (ZDeeper + ZLower + ZUpper)
                    GWUi = GWU;
                    GWLi = GWL;
                    GWDi = GWD * ((SFD(ii,jj) - ZUpper - ZLower )/ ZDeeper);
                    GWUw = 0;
                    GWLw = 0;
                    GWDw = GWD * (1 - (SFD(ii,jj) - ZUpper - ZLower )/ ZDeeper);

                elseif   SFD(ii,jj) > (ZDeeper + ZLower + ZUpper)
                    GWUi = GWU;
                    GWLi = GWL;
                    GWDi = GWD ;
                    GWUw = 0;
                ...
                if SFDg(ii,jj) > 0 && SFD(ii,jj) > 10
                    Ki = 0.7;
                    Kg = 0.00;
                    if SFDg(ii,jj) < HumousT(ii, jj)
                        GSw = GS * (SFDg(ii,jj) / HumousT(ii, jj));
                        GSi = GS * (1 - SFDg(ii,jj) / HumousT(ii, jj));
                    else
                        GSw = GS;
                        GSi = 0;
                    end
                    ...
                    if  SFDg(ii,jj) <= 300
                        if SFDg(ii,jj) <= HumousT(ii, jj)
                            GWM = SFDg(ii,jj) * (STFC(SType030(ii, jj)) - STWP(SType030(ii, jj)));
                            GSM = SFDg(ii,jj) * (STSWC(SType030(ii, jj)) - STFC(SType030(ii, jj)));
                        elseif SFDg(ii,jj) > HumousT(ii, jj) && SFDg(ii,jj) < ThickoVZ(ii, jj)
                            GWM = SFDg(ii,jj) * (STFC(SType030(ii, jj)) - STWP(SType030(ii, jj)));
                        end
                    else
                        if SFDg(ii,jj) <= HumousT(ii, jj)
                            GWM = ((STFC(SType030(ii, jj)) - STWP(SType030(ii, jj))) * 300. + (STFC(SType30100(ii, jj)) - STWP(SType30100(ii, jj))) * (SFDg(ii,jj) - 300.));
                            GSM = ((STSWC(SType030(ii, jj)) - STFC(SType030(ii, jj))) * 300. + (STSWC(SType30100(ii, jj)) - STFC(SType30100(ii, jj))) * (SFDg(ii,jj) - 300.));
                        elseif SFDg(ii,jj) > HumousT(ii, jj) && SFDg(ii,jj) < ThickoVZ(ii, jj)
                            GWM = ((STFC(SType030(ii, jj)) - STWP(SType030(ii, jj))) * 300. + (STFC(SType30100(ii, jj)) - STWP(SType30100(ii, jj))) * (SFDg(ii,jj) - 300.));
                        end
                    end

                    if SFDg(ii,jj) < ZUpper
                        GWUw = GWU * (SFDg(ii,jj) / ZUpper);
                        GWLw = 0;
                        GWDw = 0;
                        GWUi = GWU * (1 - SFDg(ii,jj) / ZUpper);
                        GWLi = GWL;
                        GWDi = GWD;
                        GWUM = GWUM * (SFDg(ii,jj) / ZUpper);
                        GWLM = 0;
                        GWDM = 0;
                    elseif SFDg(ii,jj) >= ZUpper && SFDg(ii,jj) <= (ZLower + ZUpper)
                        GWUw = GWU ;
                        GWLw = GWL * ((SFDg(ii,jj) - ZUpper )/ ZLower);
                        GWDw = 0;
                        GWUi = 0;
                        GWLi = GWL * (1 - (SFDg(ii,jj) - ZUpper )/ ZLower);
                        GWDi = GWD;
                        GWUM = GWUM;
                        GWLM = GWLM * ((SFDg(ii,jj) - ZUpper )/ ZLower);
                        GWDM = 0;
                    elseif SFDg(ii,jj) > (ZLower + ZUpper) && SFDg(ii,jj) <= (ZDeeper + ZLower + ZUpper)
                        GWUw = GWU;
                        GWLw = GWL;
                        GWDw = GWD * ((SFDg(ii,jj) - ZUpper - ZLower )/ ZDeeper);
                        GWUi = 0;
                        GWLi = 0;
                        GWDi = GWD * (1 - (SFDg(ii,jj) - ZUpper - ZLower )/ ZDeeper);
                        GWUM = GWUM;
                        GWLM = GWLM;
                        GWDM = GWDM * ((SFDg(ii,jj) - ZUpper - ZLower )/ ZDeeper);
                    elseif   SFDg(ii,jj) > (ZDeeper + ZLower + ZUpper)
                        GWUw = GWU;
                        GWLw = GWL;
                        GWDw = GWD ;
                        GWUi = 0;
                ...
                if Pe <= 0
                    ...
                    if (GSw + Pe > 0.0)
                        ...
                        if (GWUw + Pe < 0.0)
                            ...
                            GEL = (Ek - GEU) * GWLw / GWLM;
                            if isnan(GEL)
                                GEL = 0;
                            end
                            if (GWLw < DeeperC * GWLM)
                                GEL = DeeperC * (Ek - GEU);
                            end
                            if ((GWLw - GEL) < 0.0)
                                GED = GEL - GWLw;
                    ...
                    if RP == 2
                        ...
                        for m = 1:nd
                            if PPe(m) + GWw< GWM
                                ...
                                if PPe(m) + GWUw < GWUM
                                    GWUw = PPe(m) + GWUw;
                                elseif GWLw + GWUw - GWUM + PPe(m) < GWLM
                                    GWLw = GWLw + GWUw - GWUM + PPe(m);
                                    GWUw = GWUM;
                                else
                                    GWDw = GWDw + PPe(m) - (GWUM - GWUw) - (GWLM - GWLw);
                                    GWUw = GWUM;
                                    GWLw = GWLM;
                                end
                                GWw = GWUw + GWLw + GWDw;
        ...
        for iii = 1:Nx
            for jjj = 1:Ny
                ...
                if SFD(iii, jjj) >= 0
                    totalSum_SFD = totalSum_SFD + SFD(iii, jjj);
                end
                if E_act(iii, jjj) >= 0
