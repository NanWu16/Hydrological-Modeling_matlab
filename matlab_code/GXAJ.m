...
for kk = 1 : NoBasin
    ...
    for i = 1 : TSteps
        ...
        for k = 1 : DRMGCNo
            ...
            GridDs(ii,jj) = GridDs(ii,jj) + GridPObs(ii,jj) * ProbS * SCF ;
            ...
            Pr = GridPObs(ii,jj)*(1-ProbS);
            DRMPO(NextNoIJ(ii, jj)) = Pr;
            TotalPre_rain = TotalPre_rain + Pr;
            TotalPre_snow = TotalPre_snow + Ps;
    ...
    legend(["Obs", "Simu"])
    text(400, 3100, ['low_re=', num2str(low_re)]);
    text(400, 2900, ['low_nse=', num2str(low_nse)]);